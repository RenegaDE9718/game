========================================================================
    KONSOLENANWENDUNG: Semester 3 Grafik-Projektübersicht
========================================================================

Diese Semester 3 Grafik-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Semester 3 Grafik-Anwendung besteht.


Semester 3 Grafik.vcxproj
...
Semester 3 Grafik.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Semester 3 Grafik.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
